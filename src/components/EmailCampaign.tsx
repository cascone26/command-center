      ...
      <div className="scroll-y space-y-1" style={{ maxHeight: "120px" }}>
        {d.recentSends.map((s, i) => (
          ...
          >
            ...
            <span className="mono shrink-0 ml-2" style={{ color: "var(--text-dim)", fontSize: "10px" }}>
...
function FunnelRow({
  ...
  return (
    <div className="flex items-center gap-2 text-xs">
      <span className="w-20 shrink-0" style={{ color: "var(--text-dim)", fontSize: "11px" }}>
        {label}
      </span>
      <div className="flex-1 progress-track">
        <div className="progress-fill" style={{ width: `${pct}%`, background: color }} />
      </div>
      <span className="mono w-12 text-right" style={{ color, fontSize: "11px" }}>

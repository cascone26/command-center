...
export function ActivityFeed({
  ...
  return (
    <div className="panel fade-up">
      ...
      {activity.length > 0 && (
        <div className="mb-3">
          <div className="text-xs mb-1" style={{ color: "var(--text-dim)", fontSize: "10px" }}>
            TRACKER
          </div>
          <div className="space-y-0.5">
            {activity.slice(0, 6).map((a, i) => (
              ...
              >
                ...
                <span
                  className="ml-auto shrink-0 mono"
        ...
        {gitActivity.map((p) => (
          ...
          >
            <div
              ...
              style={{ background: catColors[p.category] || "var(--border)" }}
            />
            <div className="min-w-0 flex-1">
              ...
              <p className="mono truncate" style={{ color: "var(--text-dim)", fontSize: "10px" }}>
